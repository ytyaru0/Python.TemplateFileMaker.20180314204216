...
#print(os.path.isfile(os.path.expanduser('~/root/_meta/path/PathIni.py')))
...
class ConfigFile:
    ...
    def __LoadFilePath(self):
        ...
        self.__path_file_this = pathlib.Path(self.__path['work_meta_command_do']) / self.__file_name
    ...
    def __LoadTemplateDir(self):
        ...
        self.__path_dir_template = pathlib.Path(self.__path['root_db_template']) / self.__file_name
